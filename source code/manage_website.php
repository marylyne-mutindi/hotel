                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                       ...
                                       <!--   <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Footer</label>
                                                <div class="col-sm-9">
                                                    <input type="text" value="<p// echo $footer;?>"  name="footer" class="form-control">
                                                </div>
                                            </div>
                                        </div> -->
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./images/website.jpg" style="height:35%;width:25%;">
                          ...
                          <input type="file" class="form-control" name="invoice_image">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                  <image class="profile-img" src="./images/hotel.jpg" style="height:35%;width:35%;">
